...
const Footer = () => {
  return (
    <footer className="bg-tt-blue text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center">
              ...
              <span className="text-xl font-bold text-white">Servelytica</span>
            </Link>
            <p className="mt-4 text-gray-300">
              Professional table tennis analysis to elevate your game
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/coaches" className="text-gray-300 hover:text-white transition-colors">Coaches</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; {new Date().getFullYear()} Servelytica. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
